...
import { Layout, Menu, Button, Avatar, Dropdown, Space, Badge, Drawer, Typography } from 'antd';
import {
  FiMenu,
  FiPlus,
  FiSearch,
...
// Microsoft-style Logo Component
const LogoComponent = () => (
          ...
          {navigationItems.map((item) => (
            <div
              ...
              style={{
                padding: '12px 24px',
                cursor: 'pointer',
                backgroundColor: currentPath === item.href ? '#deecf9' : 'transparent',
                borderLeft: currentPath === item.href ? '3px solid #0078d4' : 'none',
                fontFamily: "'Segoe UI', system-ui, sans-serif"
              }}
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                <div style={{ color: currentPath === item.href ? '#0078d4' : '#323130' }}>
                  {item.icon}
                </div>
                <Text style={{ 
            ...
            <div style={{ 
              ...
              {navigationItems.map((item) => {
                ...
                if (['initiatives', 'education'].includes(item.key)) {
                  const submenuItems = item.key === 'initiatives' ? [
                    {
                      key: 'browse',
                  ...
                  ] : [
                    {
                      ...
                      onClick: () => router.push('/education?type=training')
                    },
                    {
                      key: 'workshops',
                      label: 'Workshops',
                      onClick: () => router.push('/education?type=workshops')
                    },
                    {
                      key: 'resources',
                      label: 'Learning resources',
                      onClick: () => router.push('/education?type=resources')
                    }
                  ];
                    ...
                    >
                      <div
                        style={{
                          ...
                          fontFamily: "'Segoe UI', system-ui, sans-serif",
                          borderBottom: pathname === item.href ? '2px solid #0067b8' : '2px solid transparent',
                          height: '60px',
                          display: 'flex',
                          alignItems: 'center',
                          paddingBottom: '2px'
