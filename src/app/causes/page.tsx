...
const PremiumStatsSection = ({ causes }: { causes: Cause[] }) => {
  ...
  const finalStats = {
    ...
    totalSupporters: causes.reduce((acc, cause) => acc + (cause.like_count || 0), 0),
    successRate: 94,
  };
...
// Premium Cause Card
const PremiumCauseCard = ({ cause, index }: { cause: Cause; index: number }) => {
            ...
            <div style={{
              ...
              {cause.cause_type && (
                <div style={{
                  ...
                  <Tag style={{
                    background: cause.cause_type === "offered" 
              ...
              {cause.priority !== 'medium' && (
                <div style={{
                  ...
                  <Badge
                    ...
                    style={{
                      backgroundColor: cause.priority === 'urgent' 
                        ? "#ff4d4f" 
                        : cause.priority === 'high' 
                        ? "#fa8c16" 
                        : "#52c41a",
        ...
        <div style={{ maxWidth: 1400, margin: "0 auto", padding: "80px 40px" }}>
          ...
          {error && (
            ...
            >
              <Card style={{
                borderRadius: 16,
                background: "linear-gradient(135deg, rgba(255, 77, 79, 0.05) 0%, rgba(245, 87, 108, 0.03) 100%)",
