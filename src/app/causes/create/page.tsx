...
export default function CreateCausePage() {
  ...
  const handleEducationFormSubmit = async (formData: any) => {
    ...
    try {
      ...
      if (result.success) {
        message.success("Your training program has been created successfully!");
      ...
      message.error("Failed to create training program. Please try again.");
    } finally {
      setLoading(false);
    }
  };
    ...
    try {
      ...
      const config =
        categoryFieldConfigs[
          selectedCategory as keyof typeof categoryFieldConfigs
        ];
      if (config) {
            ...
            >
              <Title
                ...
                style={{
                  ...
                  fontFamily: "Inter, system-ui, sans-serif",
                  textShadow:
                    "0 4px 20px rgba(0,0,0,0.6), 0 2px 10px rgba(0,0,0,0.8)",
                }}
              >
                Create Initiative
              </Title>
                  ...
                  (selectedCauseType || selectedCategory === "training") && (
                    ...
                    >
                      <Space
                        ...
                        style={{ width: "100%" }}
                      >
                        {/* Basic Information - Skip for training as EducationCauseForm includes everything */}
                        ...
                        <div style={{ textAlign: "center", marginTop: 32 }}>
                          ...
                          <div style={{ marginTop: 16 }}>
                            ...
                            >
                              Your initiative will be published immediately and
