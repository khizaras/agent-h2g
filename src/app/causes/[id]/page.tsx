  ...
  const renderFoodDetails = (details: any) => (
    <div style={{ marginBottom: 32 }}>
      ...
      >
          ...
          {details.cuisine_type && (
            <Col xs={24} md={12}>
              <div>
                ...
                <div style={{ marginTop: 4 }}>
                  <Text style={{ fontSize: 16, color: '#3c4043' }}>{details.cuisine_type}</Text>
                </div>
              </div>
            </Col>
          )}
        ...
        {/* Dietary Information */}
        {(details.vegan || details.vegetarian || details.halal || details.kosher) && (
          <div style={{ marginTop: 20, paddingTop: 16, borderTop: '1px solid #e8eaed' }}>
            <Text strong style={{ color: '#5f6368', fontSize: 12, textTransform: 'uppercase', display: 'block', marginBottom: 8 }}>
              Dietary Information
            </Text>
            <Space wrap>
              {details.vegan && <Tag style={{ backgroundColor: '#0078d4', color: 'white', border: 'none' }}>Vegan</Tag>}
              {details.vegetarian && <Tag style={{ backgroundColor: '#0078d4', color: 'white', border: 'none' }}>Vegetarian</Tag>}
          ...
          <div style={{ marginTop: 20, paddingTop: 16, borderTop: '1px solid #e8eaed' }}>
            <Space>
              ...
              <Text style={{ color: '#34a853', fontWeight: 500 }}>
                Delivery available
                {details.delivery_radius && ` within ${details.delivery_radius}km`}
              </Text>
            </Space>
          </div>
        )}
        ...
        <Row gutter={[24, 16]}>
          ...
          <Col xs={24} md={12}>
            <div>
              ...
              <div style={{ marginTop: 4 }}>
                <Tag color={details.condition === 'new' ? 'blue' : details.condition === 'like-new' ? 'blue' : 'orange'}>
                ...
                <div style={{ marginTop: 4 }}>
                  <Space wrap>
                    {details.size_range.map((size: string, index: number) => (
                      <Tag key={index} color="volcano">{size}</Tag>
                    ))}
                  </Space>
                </div>
              </div>
          ...
          {details.quantity && (
            <Col xs={24} md={12}>
              <div>
                ...
                <div style={{ marginTop: 4 }}>
                  <Text style={{ fontSize: 16, color: '#3c4043' }}>{details.quantity} items</Text>
                </div>
              </div>
            </Col>
          )}
  ...
  const renderTrainingDetails = (details: any) => (
    <div style={{ marginBottom: 32 }}>
      ...
      >
        <Row gutter={[24, 16]}>
          ...
          <Col xs={24} md={12}>
            <div>
              ...
              <div style={{ marginTop: 4 }}>
                <Tag style={{ backgroundColor: '#0078d4', color: 'white', border: 'none' }}>{details.skill_level?.replace('-', ' ')}</Tag>
              </div>
            </div>
          </Col>
            ...
            <div>
              ...
              <div style={{ marginTop: 4 }}>
                <Text style={{ fontSize: 16, color: '#3c4043' }}>
                  ...
                  {details.number_of_sessions > 1 && ` (${details.number_of_sessions} sessions)`}
                </Text>
              </div>
            </div>
          </Col>
          ...
          <Col xs={24} md={12}>
            <div>
              ...
              <div style={{ marginTop: 4 }}>
                <Text style={{ fontSize: 16, color: '#3c4043' }}>
                  {details.current_participants || 0} / {details.max_participants} enrolled
                </Text>
                <Progress 
                  percent={Math.round(((details.current_participants || 0) / details.max_participants) * 100)}
                  size="small"
                  style={{ marginTop: 4 }}
                />
              </div>
          ...
          {(details.start_date || details.end_date) && (
            <Col xs={24} md={12}>
              <div>
                ...
                <div style={{ marginTop: 4 }}>
                  <Text style={{ fontSize: 16, color: '#3c4043' }}>
                    {details.start_date && new Date(details.start_date).toLocaleDateString()}
                    {details.start_date && details.end_date && ' - '}
                    {details.end_date && new Date(details.end_date).toLocaleDateString()}
                  </Text>
                </div>
              </div>
            </Col>
        ...
        {/* Topics */}
        {details.topics && Array.isArray(details.topics) && details.topics.length > 0 && (
          <div style={{ marginTop: 20, paddingTop: 16, borderTop: '1px solid #e8eaed' }}>
            <Text strong style={{ color: '#5f6368', fontSize: 12, textTransform: 'uppercase', display: 'block', marginBottom: 8 }}>
              Topics Covered
            </Text>
            <Space wrap>
              {details.topics.map((topic: string, index: number) => (
                <Tag key={index} color="processing">{topic}</Tag>
              ))}
            </Space>
          </div>
        )}
        ...
        {details.instructor_name && (
          <div style={{ marginTop: 20, paddingTop: 16, borderTop: '1px solid #e8eaed' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
              ...
              <div>
                <Text strong style={{ fontSize: 16, color: '#3c4043', display: 'block' }}>
                  {details.instructor_name}
                </Text>
        ...
        {details.prerequisites && (
          <div style={{ marginTop: 20, paddingTop: 16, borderTop: '1px solid #e8eaed' }}>
            ...
            <div style={{ backgroundColor: '#fff3cd', padding: 12, borderRadius: 6, border: '1px solid #ffeaa7' }}>
        ...
        {details.curriculum && (
          <div style={{ marginTop: 20, paddingTop: 16, borderTop: '1px solid #e8eaed' }}>
            ...
            <div style={{ backgroundColor: '#f0f8ff', padding: 16, borderRadius: 8, border: '1px solid #b3d9ff' }}>
        ...
        <div style={{ marginTop: 20, paddingTop: 16, borderTop: '1px solid #e8eaed' }}>
          <Row gutter={24}>
            <Col xs={24} md={12}>
              <Space>
                <FiDollarSign style={{ color: details.is_free ? '#34a853' : '#1a73e8' }} />
                <Text style={{ fontSize: 16, fontWeight: 500, color: details.is_free ? '#34a853' : '#1a73e8' }}>
            ...
            {details.certification_provided && (
              <Col xs={24} md={12}>
                <Space>
                  ...
                  <Text style={{ fontSize: 16, fontWeight: 500, color: '#ea4335' }}>
      ...
      <div style={{ minHeight: '100vh', backgroundColor: '#faf9f8' }}>
        ...
        <div style={{ 
          ...
          <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 24px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <Breadcrumb
                separator={<FiChevronRight style={{ color: '#8a8886', fontSize: 12 }} />}
                items={[
                  { 
                    title: <Link href="/" style={{ color: '#0078d4', textDecoration: 'none', fontFamily: "'Segoe UI', system-ui, sans-serif" }}>Home</Link> 
                  },
                  { 
                    title: <Link href="/causes" style={{ color: '#0078d4', textDecoration: 'none', fontFamily: "'Segoe UI', system-ui, sans-serif" }}>Initiatives</Link> 
                  },
                  { 
                    title: <span style={{ color: '#323130', fontFamily: "'Segoe UI', system-ui, sans-serif" }}>{cause.title}</span>
                  }
                ]}
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '40px 24px' }}>
          <Row gutter={[32, 32]}>
              ...
              <motion.div {...animations.slideUp}>
                  ...
                  >
                    <div style={{ position: 'relative' }}>
                      ...
                      <div style={{
                        ...
                        <Tag
                          style={{
                            backgroundColor: getCauseTypeColor(cause.cause_type),
                            color: 'white',
                            border: 'none',
                            borderRadius: 4,
                            padding: '4px 8px',
                        ...
                        >
                          {cause.cause_type === 'offered' ? 'OFFERING HELP' : 'SEEKING HELP'}
                        </Tag>
                ...
                >
                  ...
                  {cause.tags && cause.tags.length > 0 && (
                    <div style={{ marginBottom: 32 }}>
                      <Title level={4} style={{ marginBottom: 16, color: '#3c4043' }}>
                        Tags
                      </Title>
                    ...
                    <Space size="large" wrap>
                      ...
                      {cause.category_name === 'training' ? (
                        ...
                        <Button
                          ...
                          size="large"
                          icon={<FiMail />}
                          onClick={() => window.location.href = `mailto:${cause.contact_email || cause.creator?.email}?subject=Interest in ${cause.title}`}
                          style={{
                            borderRadius: 4,
                            height: 40,
                            padding: '0 24px',
                      ...
                      {(cause.category_name === 'training' && (cause.contact_email || cause.creator?.email)) && (
                        <Button
                          size="large"
                          icon={<FiMail />}
                          onClick={() => window.location.href = `mailto:${cause.contact_email || cause.creator?.email}?subject=Question about ${cause.title}`}
                          style={{
                            borderRadius: 4,
                            height: 40,
                            padding: '0 24px',
                      ...
                      {cause.contact_phone && (
                        <Button
                          size="large"
                          icon={<FiPhone />}
                          onClick={() => window.location.href = `tel:${cause.contact_phone}`}
                          style={{
                            borderRadius: 4,
                            height: 40,
                            padding: '0 24px',
            ...
            <Col xs={24} lg={8}>
              <motion.div {...animations.slideUp} style={{ transitionDelay: '0.2s' }}>
                  ...
                  <div style={{ textAlign: 'center' }}>
                    ...
                    <Space direction="vertical" style={{ width: '100%' }} size={12}>
                      <Button 
                        ...
                        block
                        icon={<FiMail />}
                        onClick={() => window.location.href = `mailto:${cause.creator?.email}`}
                        style={{ 
                          borderRadius: 4,
                          height: 40,
                          backgroundColor: '#0078d4',
                  ...
                  >
                      ...
                      <Col span={12}>
                        <div style={{ 
                          ...
                          <div style={{ 
                            fontSize: '18px', 
                            fontWeight: 600, 
                            color: cause.categoryDetails.is_free ? '#107c10' : '#f7630c',
                            fontFamily: "'Segoe UI', system-ui, sans-serif"
                          }}>
                            {cause.categoryDetails.is_free ? 'Free' : `$${cause.categoryDetails.price}`}
                          </div>
                          <div style={{ 
                            fontSize: '11px', 
                            color: '#605e5c',
                      ...
                      <div style={{ marginBottom: 16 }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                          <Avatar.Group maxCount={3} size="small">
                            ...
                            <Avatar style={{ backgroundColor: '#0078d4' }}>JD</Avatar>
                            <Avatar style={{ backgroundColor: '#107c10' }}>AS</Avatar>
                            <Avatar style={{ backgroundColor: '#d13438' }}>MK</Avatar>
                          </Avatar.Group>
                          <Text style={{ 
                            fontSize: 11, 
                            color: '#8a8886',
                            ...
                            and {Math.max(0, (cause.categoryDetails.current_participants || 0) - 3)} others
                          </Text>
                        </div>
                      </div>
                    )}
                    ...
                    {cause.categoryDetails.certification_provided && (
                      <div style={{ 
                        ...
                        <FiAward style={{ color: '#f7630c', marginRight: 6 }} />
                        <Text style={{ 
                          fontSize: 12, 
                          color: '#f7630c',
                          fontWeight: 600,
