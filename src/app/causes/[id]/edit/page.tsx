...
import { EducationCauseForm } from "@/components/forms/EducationCauseForm";
...
const categoryFieldConfigs = {
  food: {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "textarea",
        placeholder: "Calories, nutrients, etc.",
      },
      {
  ...
  clothes: {
    ...
    fields: [
      ...
      {
        name: "donationReceiptAvailable",
        label: "Donation Receipt Available",
        type: "switch",
      },
    ],
  },
  training: {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "textarea",
        placeholder: "Class timings, days of the week, frequency...",
      },
      {
        name: "deliveryMethod",
      ...
      },
      {
        ...
        type: "textarea",
        required: true,
        placeholder: "Brief outline of topics to be covered...",
      },
      {
        name: "instructorName",
      ...
      },
      {
        ...
        label: "Materials Required by Students",
        type: "multiselect",
        options: [
          "laptop",
          "desktop",
...
export default function EditCausePage() {
  ...
  const handleEducationFormSubmit = async (formData: any) => {
    if (!causeData) return;

    setSaving(true);
    try {
      // Get basic form values
      const basicValues = await form.getFieldsValue();

      // Combine basic form data with education form data
      const submitData = {
        title: basicValues.title,
        description: basicValues.description,
        location: basicValues.location,
        priority: basicValues.priority,
        contactEmail: basicValues.contactEmail,
        contactPhone: basicValues.contactPhone,
        tags: basicValues.tags,
        categoryDetails: formData,
      };

      const response = await fetch(`/api/causes/${causeData.id}`, {
        method: "PUT",
        headers: {
      ...
      if (result.success) {
        ...
        router.push(`/causes/${causeData.id}`);
      } else {
        throw new Error(result.error || "Failed to update training program");
      }
    } catch (error) {
      console.error("Error updating training program:", error);
      message.error("Failed to update training program. Please try again.");
    } finally {
      setSaving(false);
    }
  };
    ...
    try {
      ...
      const config =
        categoryFieldConfigs[
          causeData.category_name as keyof typeof categoryFieldConfigs
        ];
        ...
        >
          <div style={{ maxWidth: 1000, margin: "0 auto", padding: "24px" }}>
            ...
            >
              ...
              >
                Update your {selectedCategory?.label.toLowerCase()} initiative
                details
              </Text>
            </motion.div>
          </div>
          ...
          <Form form={form} layout="vertical">
            ...
            >
              ...
              >
                ...
                {causeData.category_name === "training" ? (
                  <motion.div variants={premiumAnimations.itemVariants}>
                    <EducationCauseForm
                      ...
                      >
                        ...
                        >
                          ...
                          <span style={{ marginLeft: 8 }}>
                            {causeData.category_name.charAt(0).toUpperCase() +
                              causeData.category_name.slice(1)}{" "}
                            Details
                          </span>
                        </Title>
                ...
                <div style={{ textAlign: "center", marginTop: 32 }}>
                  ...
                  <div style={{ marginTop: 16 }}>
                    ...
                    >
                      Your updated initiative will be visible to the community
                      immediately
                    </Text>
                  </div>
                </div>
