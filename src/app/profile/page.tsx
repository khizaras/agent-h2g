  ...
  useEffect(() => {
    ...
    const fetchProfileData = async () => {
      try {
        ...
        const [causesResponse, contributionsResponse, activitiesResponse] =
          await Promise.all([
        ...
        if (contributionsResponse.ok) {
          ...
          userContributions = contributionsData.success
        ...
        if (activitiesResponse.ok) {
          ...
          userActivities = activitiesData.success
            ? activitiesData.data || []
            : [];
        }
        ...
        const stats = {
          ...
          totalRaised: userCauses.reduce((sum, c) => sum + (c.raised || 0), 0),
        ...
        const badges = [
          {
            ...
            earnedDate:
              stats.causesCreated >= 1 ? userCauses[0]?.createdAt : undefined,
          },
          {
            ...
            earnedDate:
              stats.causesCreated >= 5 ? userCauses[4]?.createdAt : undefined,
          },
          {
            id: "generous-donor",
            name: "Generous Donor",
            ...
            earnedDate:
              stats.totalDonated >= 1000
                ? userContributions.find((c) => c.type === "donation")?.date
                : undefined,
          },
          {
            id: "volunteer-hero",
            ...
            earnedDate:
              stats.volunteersHours >= 100
                ? userContributions.find((c) => c.type === "volunteer")?.date
                : undefined,
          },
        ];
                              ...
                              {profile.badges.length > 0 ? (
                                ...
                                <div className="text-center py-12">
                                  ...
                                  <Paragraph className="text-gray-400 mb-6">
                                    Start participating in the community to earn
                                    your first badge!
                                  </Paragraph>
                            ...
                            >
                              ...
                              {profile.activities.length > 0 ? (
                                ...
                                >
                                  ...
                                  >
                                    Start creating causes or supporting others
