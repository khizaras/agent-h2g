...
async function createCategoriesTables() {  // Use environment variables if available, otherwise use defaults
  ...
  try {
    ...
    `);
    console.log("Categories table created");    // Create category_fields table
    await connection.query(`
    ...
    `);
    console.log("Category_fields table created");    // Create cause_category_values table    await connection.query(`
